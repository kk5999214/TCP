...
uid=4419,password=xanaf_6RBVE_BY

# OR Format 2: Line-separated
# uid: 441668
# password: xanaf_6RBVE_BY
...
📱 Player will see:
"XANAFᅠ wants to join your team"
...
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY ㅤXEROX MODS
"""
        else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][DA70D6]❀️Dev:[FFFFFF]</> XEROX MODS
"""
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]XEROX MODS
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FFD700]━━━━━━━━━━━━━━━━━━━━━━
[FF00FF]✨ Developed by XEROX MODS✨"""
...
[C][B][FFFF00]│[FF0000]▶[00FFFF]│[00FFFF]║[FFFFFF] XEROX MODSTCP BOT[FFFF00]║
...
[b][c][00FF00]Wʟᴄ Tᴏ TEAM X LEGACY Bᴏᴛ Hᴇʀᴇ 
...
[4DA6FF]│
[FFFFFF]├ Owner : [FFFF00] XEROX MODS
[FFFFFF]└ TG : [00FF00]@XEROX_MODS
...
[00FF00]✨ Developed by XEROX MODS
"""
                                await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                            else:
                                date_string = parts[1]
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=400089,password=xanaf_6RBVE_BY_SUL")
        return None
